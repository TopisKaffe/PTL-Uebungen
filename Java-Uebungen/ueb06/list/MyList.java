...
public abstract class MyList<E> {
    ...
    /**
     * returns a list, filtered with the criteria of 'fill' 
     * @param fill functionObject with criteria
     * @return a list, filtered with the criteria of 'fill' 
     */
    
    //public MyList<E> filter(PredicateFunctionObject<E> fill){}
